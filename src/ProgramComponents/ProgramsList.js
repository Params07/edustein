            ...
            <div className="bg-[#2E3B4E] py-6 rounded-md">
                ...
                <div className="p-4 md:p-6 xl:p-8 grid gap-y-16 gap-x-0  lg:grid-cols-2 place-items-center font-redhat">
                    {programs.map((program, index) => (
                        <div
                            key={index}
                            className="shadow-lg shadow-current w-[18rem] md:w-[32rem] sm:w-[26rem] lg:w-[27rem] xl:w-[32rem] 2xl:w-[39rem] 
                               h-[24.5rem] sm:h-[32.5rem]  
                             lg:h-[34rem] 2xl:h-[37rem] xl:h-[35.8rem]  bg-white rounded-md md:rounded-xl p-3 sm:p-4  xl:p-8"
                        >
                            <div>
                                <span className="font-redhat font-semibold text-xl xl:text-2xl">{program.title}</span>
                            </div>
                            <div className="  w-full  h-[10rem] sm:h-[18rem] md:h-[19rem]  2xl:h-[20rem] xl:h-[19rem] 
